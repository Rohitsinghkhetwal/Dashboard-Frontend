...
const UpdateProducts = () => {
    ...
    console.log("this is the data from ", name, email, mobile, course, gender,designation, imageUrl)
    ...
    const onGenderChange = (e) => {
      ...
      const updateUser = async(e) => {
        ...
        try{
            ...
            let response = await fetch(`http://localhost:7800/api/v1/users/update/${id}`,{
                method: "PUT",
                body: formData,
                headers: {
                    "Authorization": token
            ...
            <div className="max-w-md w-full space-y-8">
                <div>
                    ...
                    <div className="mt-2 text-center ">
                        <h2 className="text-xl text-slate-900">Form to update the user..</h2>

                        
                    </div>
                </div>
                <form className="mt-8 space-y-6" onSubmit={updateUser}>
